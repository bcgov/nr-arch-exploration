...
function deployPostgres{
  try{
    oc process -f "https://raw.githubusercontent.com/bcgov/nr-arch-templates/main/Metabase/openshift/postgres/postgres.yml"  -p NAMESPACE="$NAMESPACE-$ENVIRONMENT" -p DB_PVC_SIZE=250Mi | oc -n "$NAMESPACE-$ENVIRONMENT" create -f -
  }catch{
